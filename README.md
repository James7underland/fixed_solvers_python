...
Python-порт C++-библиотеки `fixed_solvers`: метод Ньютона–Рафсона для систем нелинейных уравнений известной или переменной размерности, бисекция/секущие, оптимизация Гаусса–Ньютона, линейный поиск и вспомогательная математика.
...
Квадратичное программирование — метод Goldfarb–Idnani (`solve_quadprog` / `solve_quadprog_box`), как `testing/qp/eiquadprog.hpp`.
